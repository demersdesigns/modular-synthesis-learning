...
`ADMIN_PASSWORD` is the password you will enter at `/admin/login`. Set it to anything you like — there is no default. The admin interface will be inaccessible until this value is set.
